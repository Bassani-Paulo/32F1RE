...
func setWeatherOdds():
	rng.randomize()
	clearOdds = int(100*rng.randf_range(0.51, 0.8))
	sandstormOdds = int(100*rng.randf_range((1-clearOdds/100.0)*0.7, (1-clearOdds/100.0)*0.9))
...
var gunsmithMods = [StatMod.new("- Accuracy: within 0.1 standard area", Enums.Stat.ACCURACY, Enums.Operation.SET, 0.1), StatMod.new("- Reload Speed modifier: x0.25", Enums.Stat.RELOAD_TIME, Enums.Operation.SET, 0.25), StatMod.new("- Repair Time modifier: x0.25", Enums.Stat.REPAIR_TIME, Enums.Operation.SET, 0.25)]
var regularMods = [StatMod.new("- Accuracy: within 0.5 standard area", Enums.Stat.ACCURACY, Enums.Operation.SET, 0.5), StatMod.new("- Reload Speed modifier: x1", Enums.Stat.RELOAD_TIME, Enums.Operation.SET, 1), StatMod.new("- Repair Time modifier: x1", Enums.Stat.REPAIR_TIME, Enums.Operation.SET, 1)]
var shooterMods = [StatMod.new("- Accuracy: within 0.9 standard area", Enums.Stat.ACCURACY, Enums.Operation.SET, 0.9), StatMod.new("- Reload Speed modifier: x2", Enums.Stat.RELOAD_TIME, Enums.Operation.SET, 2), StatMod.new("- Repair Time modifier: x2", Enums.Stat.REPAIR_TIME, Enums.Operation.SET, 2)]
var testBackgrounds = [Item.new("Gunsmith", gunsmithMods), Item.new("Regular", regularMods), Item.new("Shooter", shooterMods)]

var lowCaliberRevolverMods = [StatMod.new("- Rate of Fire: 2 rounds per second", Enums.Stat.ROF, Enums.Operation.SET, 2), StatMod.new("- Reload time: 9 seconds", Enums.Stat.RELOAD_TIME, Enums.Operation.MULTIPLY, 9), StatMod.new("- Ammo Capacity: 6 rounds", Enums.Stat.AMMO_CAPACITY, Enums.Operation.SET, 6), StatMod.new("- Bullet Speed: 0.5 seconds", Enums.Stat.BULLET_SPEED, Enums.Operation.SET, 0.5), StatMod.new("- Fail chance: 10%", Enums.Stat.FAIL_CHANCE, Enums.Operation.SET, 0.1), StatMod.new("- Repair time: 2 seconds", Enums.Stat.REPAIR_TIME, Enums.Operation.MULTIPLY, 2), StatMod.new("- Accuracy modifier: x1.5", Enums.Stat.ACCURACY, Enums.Operation.MULTIPLY, 1.5)]
